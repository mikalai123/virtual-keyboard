console.log('Добрый день! выполнил по ТЗ меньше чем сам ожидал(. реализована генерация DOM-элементов и body в index.html пустой изначально,реализована анимация нажатия на кнопку,использование в коде фишек стандарта ES6,установлен eslint, требования к репозиторию, коммитам и PR выполнены. ХОРОШЕГО ДНЯ!')
